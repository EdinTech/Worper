...
import { TemplateControlProps } from '../../../../util/interface/pages';
...
const TemplateControl: React.FC<TemplateControlProps> = ({ isChecked, isValidated, onCreate, onEdit, onDelete }) => {
