...
const PatchingTemplateModifyPage: React.FC = () => {
    ...
    const { templateListItem: locatedTemplateListItem, type } = location.state as PatchingTemplateModifyPageProps;
    ...
    return (
        <>
            ...
            <TemplateModifyFileInformation templateListItem={templateListItem} setTemplateListItem={setTemplateListItem}  />
            ...
            {/* button component */}
            <TemplateModifyControl onCreate={onCreate} onUpdate={onUpdate} onDelete={onDelete} type={type} />
        </>
    )
}
